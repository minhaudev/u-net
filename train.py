...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-mode", type=str, default="gating", choices=["gating", "orig", "clahe", "fusion", "ca_unet", "camlp_unet"], help="Chọn nhánh để test ablation")
...
def main() -> None:
    ...
    elif args.input_mode == "camlp_unet":
        model = CAMLP_UNet(
            in_channels=1,
            out_channels=1,
            base_channels=args.base_channels,
